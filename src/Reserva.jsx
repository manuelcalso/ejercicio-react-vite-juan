...
export default function Reserva() {
  ...
  const serverUrl = import.meta.env.VITE_SERVER_URL_RES;
    ...
    <>
      <section className="sectionreserva flex flex-col justify-center">
        ...
        <div className="flex flex-row items-center justify-center">
          <form
            className="flex flex-col justify-center items-center m-5 border border-black bg-[#45ebf7] rounded w-80"
            ...
            <div>
              <div>
                <label htmlFor="description">
                  Descripcion de la reservacion
                </label>
                <br />
                <textarea
                  type="text"
                  name="description"
                  placeholder="cuantas personas, zona abierta o cerrada..."
              ...
              <div className="flex flex-row justify-center items-center h-20">
                <button className="reservabutton text-white rounded bg-[#644164] w-50 h-20">
                  {" "}
                  Crear Reservacion
                </button>
              </div>
